#!/usr/bin/env bash
# File    : pth2safe.sh
# Purpose : Wrapper for `pth2safe.py` that handles the python virtual environment
...
REQ_VARIANT="_torch"                                      # allows specifying variants of requirements files (empty == default)
